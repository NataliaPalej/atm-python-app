...
c1 = Customer("Lilly", "Mayor", "Female", "Employed", "Athlone", "089 421 4578", "LillyMayor@gmail.com", "123456", "1234")
c2 = Customer("Lola", "Kennedy", "Undefined", "Student", "Roscommon", "087 421 1234", "LolaKennedy@gmail.com", "987654", "9876")
c3 = Customer("Mike", "Smith", "Male", "Unemployed", "Dublin", "086 123 4578", "MikeSmith@gmail.com", "456132", "6789")
...
def details_screen():
    ...
    detail_screen = CustomerDetails(window2, customer_list)
